...
QGLAPI void (APIENTRYP qglFogi)(GLenum pname, GLint param);
QGLAPI void (APIENTRYP qglFogf)(GLenum pname, GLfloat param);
QGLAPI void (APIENTRYP qglFogfv)(GLenum pname, const GLfloat *param);
